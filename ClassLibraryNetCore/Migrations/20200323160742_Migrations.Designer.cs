...
namespace ClassLibraryNetCore.Migrations
{
    ...
    [Migration("20200323160742_Migrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassLibraryNetCore.AlbumArtist", b =>
                {
                    b.Property<int>("AlbumId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassLibraryNetCore.AlbumArtist", b =>
                {
                    b.HasOne("ClassLibraryNetCore.Album", "Album")
                        .WithMany("AlbumArtist")
                        .HasForeignKey("AlbumId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClassLibraryNetCore.Artist", "Artist")
