...
namespace PhotosAPI
{
    public class APIClass
    {
        ...
        {
            Console.WriteLine(myPhotoTable.Name);
            databaseModelContainer.MyPhotoTableSet.Attach(myPhotoTable);
            databaseModelContainer.MyPhotoTableSet.Remove(myPhotoTable);
            databaseModelContainer.SaveChanges();
        }
        public void deletePhotoById(int id)
        {
            var photo = getInfoById(id);
            databaseModelContainer.MyPhotoTableSet.Remove(photo);
            databaseModelContainer.SaveChanges();
        }
